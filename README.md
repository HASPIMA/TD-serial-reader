...
You can download these binaries under the section `Assets`. Here is an
example for `v2.1.2`:

![Example of generated assets under version `v2.1.2`](docs/release_assets.png)

These assets are auto-generated by the release workflow. To understand
how this works refer to the [workflows section](#github-workflows).
